...
export function TokenSpend({ active = true, settings, onSubscriptionsSaved }: { active?: boolean; settings?: AppSettings | null; onSubscriptionsSaved?: (subs: Record<string, SubscriptionRecord>) => void }){
