...
export function UsageRing({usage,settings,onHover,refreshing,onClick}:{usage:ProviderUsage;settings:AppSettings;onHover:()=>void;refreshing?:boolean;onClick?:()=>void}){
